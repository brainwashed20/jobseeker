...
class UserAccountsControllerTest < ActionController::TestCase
  ...
  test "should create user_account" do
    assert_difference('UserAccount.count') do
      post :create, user_account: { data_nasterii: @user_account.data_nasterii, nume: @user_account.nume, prenume: @user_account.prenume }
    end
  ...
  test "should update user_account" do
    patch :update, id: @user_account, user_account: { data_nasterii: @user_account.data_nasterii, nume: @user_account.nume, prenume: @user_account.prenume }
    assert_redirected_to user_account_path(assigns(:user_account))
  end
